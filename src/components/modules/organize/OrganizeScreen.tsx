    ...
    return (
      <div className="h-full flex flex-col">
          ...
          <Card>
              ...
              {/* Operation Type */}
              <FormGroup>
                  <FormLabel>{t('organize.operation')}</FormLabel>
              ...
              <FormGroup>
                  <FormLabel>{t('organize.pattern')}</FormLabel>
              ...
              {/* Conflict Resolution */}
              <FormGroup>
                  <FormLabel>{t('organize.conflicts')}</FormLabel>
              ...
              {/* Basic Options */}
              <FormGroup>
                  <FormLabel>{t('organize.options')}</FormLabel>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <FormCheckbox
                        id="recursive"
                        name="recursive"
                        label={t('organize.recursive')}
                        checked={recursive}
                      ...
                      <FormCheckbox
                        id="skipDuplicates"
                        name="skipDuplicates"
                        label={t('organize.skipDuplicates')}
